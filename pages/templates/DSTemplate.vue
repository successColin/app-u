...
<script>
	...
	export default{
		...
		methods: {
			...
			handleSure(){
				if(!this.tabInfo.relationTableName || !this.tabInfo.mainnColumn || !this.tabInfo.relationColumn || !this.BusinessID) return
				const relations = [],_this = this
				let baseConfig = {
